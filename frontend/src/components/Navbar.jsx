import JobSearch from "@/components/jobs/SearchLocation";
  ...
  return (
    ...
    >
      ...
      <div className="flex md:hidden mx-4 mb-5">
        <div
          className="w-full h-12 border border-gray-300 shadow-md bg-white rounded-md relative flex items-center px-4 cursor-pointer"
